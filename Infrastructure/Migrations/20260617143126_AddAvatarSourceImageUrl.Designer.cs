...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260617143126_AddAvatarSourceImageUrl")]
    partial class AddAvatarSourceImageUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Customer.Avatar", b =>
                {
                    ...
                    b.Property<double?>("AvatarFocalLength")
                        .HasColumnType("double precision")
                        .HasColumnName("avatar_focal_length");
            ...
            modelBuilder.Entity("Domain.Entities.Customer.Cart", b =>
                {
                    ...
                    b.HasIndex("CustomerAccountId")
                        .HasDatabaseName("ix_carts_customer_account_id");

                    b.ToTable("carts", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.Customer.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrders.COrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("c_orders", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.CustomerOrders.COrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_c_order_items");

                    b.HasIndex("COrderId")
                        .HasDatabaseName("ix_c_order_items_c_order_id");

                    b.ToTable("c_order_items", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.CustomerOrders.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrders.TrackingHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tracking_history");

                    b.HasIndex("COrderId")
                        .HasDatabaseName("ix_tracking_history_c_order_id");

                    b.ToTable("tracking_history", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Customer.Cart", b =>
                {
                    b.HasOne("Domain.Entities.Customer.CustomerAccount", "CustomerAccount")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_carts_customer_accounts_customer_account_id");
            ...
            modelBuilder.Entity("Domain.Entities.Customer.CartItem", b =>
                {
                    b.HasOne("Domain.Entities.Customer.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrders.COrderItem", b =>
                {
                    b.HasOne("Domain.Entities.CustomerOrders.COrder", null)
                        .WithMany("COrderItems")
                        .HasForeignKey("COrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_c_order_items_c_orders_c_order_id");
                });
            ...
            modelBuilder.Entity("Domain.Entities.CustomerOrders.TrackingHistory", b =>
                {
                    b.HasOne("Domain.Entities.CustomerOrders.COrder", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tracking_history_c_orders_c_order_id");
                });
