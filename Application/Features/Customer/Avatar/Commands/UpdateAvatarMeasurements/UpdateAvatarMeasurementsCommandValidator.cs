...
public sealed class UpdateAvatarMeasurementsCommandValidator : AbstractValidator<UpdateAvatarMeasurementsCommand>
{
    public UpdateAvatarMeasurementsCommandValidator()
    {
